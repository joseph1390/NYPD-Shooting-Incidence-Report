...
I do not these columns: INCIDENT_KEY, OCCUR_TIME, PRECINCT, JURISDICTION_CODE, LOCATION_DESC, LOC_CLASSFCTN_DESC, LOC_OF_OCCUR_DESC, X_COORD_CD, Y_COORD_CD, Latitude, Longitude, Lon_Lat, PERP_SEX, VIC_SEX.
...
The majority of victims as well as perpetrators of shootings both fatal and non-fatal are Black. The majority of victims as well as perpetrators of shootings both fatal and non-fatal are between the age groups 18-24 and 25-44 at the time of writing. Brooklyn and the Bronx experience the most shooting incidences.
